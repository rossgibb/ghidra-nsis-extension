...
public class NsisLoader extends PeLoader {
  ...
  public Collection<LoadSpec> findSupportedLoadSpecs(ByteProvider provider) throws IOException {
    // TODO call super to handle PE portion of the file
  ...
  protected void load(ByteProvider provider, LoadSpec loadSpec, List<Option> options,
    ...
    try {
      ...
      FileBytes fileBytes = MemoryBlockUtils.createFileBytes(program, provider, scriptHeaderOffset,
  ...
  private void initScriptHeader(FileBytes fileBytes, Address scriptHeaderAddress, long size,
      Program program, DataType dataType) throws MemoryConflictException, AddressOverflowException,
